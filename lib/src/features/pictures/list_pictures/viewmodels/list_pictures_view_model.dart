...
import 'package:progres/src/features/pictures/_shared/providers/pictures_providers.dart';
import 'package:progres/src/features/pictures/_shared/repositories/pictures_repository.dart';

/// ViewModel for the pictures list screen.
///
/// This class is responsible for managing the state of the pictures list,
/// including loading the pictures from the repository and handling loading/error states.
...
class PicturesViewModel
  ...
  /// Loads the pictures from the repository and updates the state.
  ///
  /// Sets the state to loading, then tries to fetch the pictures.
