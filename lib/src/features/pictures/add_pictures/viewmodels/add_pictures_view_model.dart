...
/// ViewModel for the add pictures screen.
///
/// This class is responsible for managing the state of the pictures being added.
...
class AddPicturesViewModel extends StateNotifier<List<ProgressPicture>> {
  ...
  ///
  /// It takes an initial list of pictures and sets it as the initial state.
  AddPicturesViewModel(super.initialPictures);

  /// Adds a list of pictures to the current state.
...
/// widget tree. It uses the `family` modifier to pass the initial list of pictures
/// to the view model.
